...
namespace LittleParser.DataAccess.Persistance.Repositories
{
    public interface IApacheLogRepository
    {
        ...
        IEnumerable<ApacheLog> GetTopHosts(DateTimeOffset start, DateTimeOffset end, long n);

        IEnumerable<ApacheLog> GetTopRoutes(DateTimeOffset start, DateTimeOffset end, long n);
    }
}